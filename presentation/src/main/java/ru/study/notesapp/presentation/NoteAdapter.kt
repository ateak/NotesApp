...
import ru.study.notesapp.presentation.databinding.RecyclerviewItemBinding
...
class NoteAdapter(val listener: Listener) : RecyclerView.Adapter<NoteAdapter.NoteHolder>() {
    ...
    fun updateData(newNoteList: List<Note>) {
        val diffUtil = ru.study.notesapp.presentation.NoteDiffUtil(oldNoteList, newNoteList)
